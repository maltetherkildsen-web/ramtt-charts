...
function MetricsStripDemo() {
  return (
    <DemoSection title="Metrics Strip">
      <Card padding="none">
        <div className="flex py-1" style={{ borderColor: 'var(--n400)' }}>
          {[
            ...
            <div
              ...
              style={i < arr.length - 1 ? { borderRight: '0.5px solid var(--n400)' } : undefined}
            >
              <MetricCard {...m} />
            </div>
          ))}
...
function ToggleGroupDemo() {
  ...
  const [filters, setFilters] = useState<string | string[]>(['all'])
    ...
    <DemoSection title="Toggle Groups">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <span className="text-[12px]" style={{ fontFamily: 'var(--font-sans)', color: 'var(--n800)' }}>
      ...
      <div className="mx-auto max-w-[920px] px-6">
        ...
        <header className="mb-16">
          <h1
            ...
            style={{ fontFamily: 'var(--font-label)', fontWeight: 500, color: 'var(--n1150)' }}
          >
            @ramtt/ui
          </h1>
          <p
            className="mt-2 max-w-lg text-[14px] leading-relaxed"
            style={{ fontFamily: 'var(--font-sans)', fontWeight: 450, color: 'var(--n800)' }}
          >
            Minimal, opinionated UI components with RAMTT design tokens baked in.
            Zero dependencies. Every number in JetBrains Mono, every label in Space
            Grotesk, every border at 0.5px.
          </p>
        </header>
