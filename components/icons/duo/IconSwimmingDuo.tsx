...
export const IconSwimmingDuo = forwardRef<SVGSVGElement, IconDuoProps>((props, ref) => (
  <IconBaseDuo ref={ref} {...props}>
    {/* Background */}
    <g fill={props.accent || "currentColor"} stroke="none" opacity={0.15}>
      <path d="M2 18c1-1 2-1.5 3.5-1.5S8 18 9 18s2-.5 3.5-1.5S15 15 16.5 16.5 20 18 22 18v4H2v-4z"/>
    </g>
    {/* Foreground */}
...
IconSwimmingDuo.displayName = 'IconSwimmingDuo'
