...
export const IconGlucoseMoleculeDuo = forwardRef<SVGSVGElement, IconDuoProps>((props, ref) => (
  <IconBaseDuo ref={ref} {...props}>
    {/* Background */}
    <path d="M8 7l4-2 4 2v4l-2 3H10L8 11Z" fill={props.accent || 'currentColor'} stroke="none" opacity={0.15}/>
    {/* Foreground */}
...
IconGlucoseMoleculeDuo.displayName = 'IconGlucoseMoleculeDuo'
