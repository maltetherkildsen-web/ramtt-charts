...
export const IconPaletteDuo = forwardRef<SVGSVGElement, IconDuoProps>((props, ref) => (
  <IconBaseDuo ref={ref} {...props}>
    {/* Background */}
    <g fill={props.accent || "currentColor"} stroke="none" opacity={0.15}>
      <path d="M12 2a10 10 0 00-1 19.95c1.1.1 1.7-.72 1.7-1.45 0-.35-.15-.7-.42-.98-.55-.55-.85-1.15-.85-1.77A2.25 2.25 0 0113.68 15.5H16a6 6 0 006-5.5A10 10 0 0012 2z"/>
    </g>
    {/* Foreground */}
...
IconPaletteDuo.displayName = 'IconPaletteDuo'
