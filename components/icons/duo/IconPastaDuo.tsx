...
export const IconPastaDuo = forwardRef<SVGSVGElement, IconDuoProps>((props, ref) => (
  <IconBaseDuo ref={ref} {...props}>
    {/* Background */}
    <g fill={props.accent || "currentColor"} stroke="none" opacity={0.15}>
      <path d="M8 8c0 3 1.5 5 4 6 2.5-1 4-3 4-6H8z"/>
    </g>
    {/* Foreground */}
...
IconPastaDuo.displayName = 'IconPastaDuo'
